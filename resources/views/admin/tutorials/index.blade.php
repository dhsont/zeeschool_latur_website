...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            @include('admin.layouts.partials.pageheader',['title'=>'tutorials', 'desc'=>'tutorials',$links = ['Create $tutorial'=> '/myadmin/tutorials/create']])
                    ...
                    @if ($tutorials->count())
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-user"></i>tutorials
                                </div>
                                <div class="actions">
                                    <div class="btn-group">
                                        ...
                                        <div id="sample_2_column_toggler"
                                            ...
                                            <label><input type="checkbox" checked data-column="0">$tutorial</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class='btn btn-info fa fa-edit'
                                                       href="/myadmin/tutorials/{!!$tutorial->id!!}/edit"> </a>

                                                    <a href="{!! route('tutorials.delete', [$tutorial->id]) !!}"
                                                       onclick="return confirm('Are you sure wants to delete this $tutorial?')"><i

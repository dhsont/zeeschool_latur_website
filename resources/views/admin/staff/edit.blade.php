...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            @include('admin.layouts.partials.pageheader',['title'=>"Update: staff", 'desc'=>'',$links = ['all staff'=> '/myadmin/staff']])
                ...
                <div class="col-md-12">
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder fa-pencil-square-o "></i> Update :staff
                            </div>
                        ...
                        <div class="portlet-body form">
                            ...
                            {!!
                            Former::horrizontal_open_for_files()->populate($staff)->method('PATCH')->action('/myadmin/staff/'.$staff->id)!!}
                            <div class="form-body">

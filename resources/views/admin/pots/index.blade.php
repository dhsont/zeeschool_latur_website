...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            @include('admin.layouts.partials.pageheader',['title'=>'Pot', 'desc'=>'Pot',$links = ['Create pot'=> '/myadmin/pots/create']])
                                ...
                                <div class="actions">
                                    <div class="btn-group">
                                        ...
                                        <div id="sample_2_column_toggler"
                                            ...
                                            <label><input type="checkbox" checked data-column="0">pot</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
			...
			<th>Desc</th>
					...
					<td>{!! $pot->desc !!}</td>
                                            <td>
                                                ...
                                                href="/myadmin/pots/{!!$pot->id!!}"></a>
                                                <a class='btn btn-info fa fa-edit'
                                                       href="/myadmin/pots/{!!$pot->id!!}/edit"> </a>

                                                    <a href="{!! route('pots.delete', [$pot->id]) !!}"
                                                       onclick="return confirm('Are you sure wants to delete this pot?')"><i

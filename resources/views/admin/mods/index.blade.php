...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            @include('admin.layouts.partials.pageheader',['title'=>'mods', 'desc'=>'mods',$links = ['Create mod'=> '/myadmin/mods/create']])
                                ...
                                <div class="actions">
                                    <div class="btn-group">
                                        ...
                                        <div id="sample_2_column_toggler"
                                            ...
                                            <label><input type="checkbox" checked data-column="0">mod</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
					...
					<td>{!! $mod->age !!}</td>
                                            <td>
                                                <a class='btn btn-info fa fa-edit'
                                                       href="/myadmin/mods/{!!$mod->id!!}/edit">EDIT </a>

                                                    <a href="{!! route('mods.delete', [$mod->id]) !!}"
                                                       onclick="return confirm('Are you sure wants to delete this mod?')"><i

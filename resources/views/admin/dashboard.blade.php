@extends('admin.layouts.master-noscripts')
                                    ...
                                    <div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
                                        <div class="row">
                                            <div class="col-md-6 user-info">
                                                <img alt="" src="/assets/admin/img/avatar.png" class="img-responsive"/>
                                                <div class="details">
                                                    <div>
                                                        <a href="#">
                                                            Robert Nilson
                ...
                <div class="portlet">
                    ...
                    <div class="portlet-body" id="chats">
                        <div class="scroller" style="height: 435px;" data-always-visible="1" data-rail-visible1="1">
                            <ul class="chats">
                                <li class="in">
                                    <img class="avatar img-responsive" alt="" src="/assets/admin/img/avatar1.jpg"/>
                                    <div class="message">
											<span class="arrow">
											</span>
                                        <a href="#" class="name">
                                ...
                                <li class="out">
                                    <img class="avatar img-responsive" alt="" src="/assets/admin/img/avatar2.jpg"/>
                                    <div class="message">
											<span class="arrow">
											</span>
                                        <a href="#" class="name">
                                ...
                                <li class="out">
                                    <img class="avatar img-responsive" alt="" src="/assets/admin/img/avatar3.jpg"/>
                                    <div class="message">
											<span class="arrow">
											</span>
                                        <a href="#" class="name">
...
@section('scripts')
    ...
    <script src="/assets/admin/scripts/custom/tasks.js" type="text/javascript"></script>

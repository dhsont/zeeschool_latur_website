...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            @include('admin.layouts.partials.pageheader',['title'=>'mmms', 'desc'=>'mmms',$links = ['Create mmm'=> '/myadmin/mmms/create']])
                                ...
                                <div class="actions">
                                    <div class="btn-group">
                                        ...
                                        <div id="sample_2_column_toggler"
                                            ...
                                            <label><input type="checkbox" checked data-column="0">mmm</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
					...
					<td>{!! $mmm->age !!}</td>
                                            <td>
                                                <a class='btn btn-info fa fa-edit'
                                                       href="/myadmin/mmms/{!!$mmm->id!!}/edit">EDIT </a>

                                                    <a href="{!! route('mmms.delete', [$mmm->id]) !!}"
                                                       onclick="return confirm('Are you sure wants to delete this mmm?')"><i

...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            @include('admin.layouts.partials.pageheader',['title'=>"Update: faq", 'desc'=>'',$links = ['all faqs'=> '/myadmin/faqs']])
                ...
                <div class="col-md-6">
                    <div class="portlet box blue ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder fa-pencil-square-o "></i> Update :faq
                            </div>
                        ...
                        <div class="portlet-body form">
                            ...
                            {!!
                            Former::horrizontal_open()->populate($faq)->method('PATCH')->action('/myadmin/faqs/'.$faq->id)!!}
                            <div class="form-body">

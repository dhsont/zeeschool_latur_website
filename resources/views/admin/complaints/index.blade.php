...
@section('content')
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            @include('admin.layouts.partials.pageheader',['title'=>'complaints', 'desc'=>'complaints',$links = ['Create complaint'=> '/myadmin/complaints/create']])
                    ...
                    @if ($complaints->count())
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-user"></i>complaints
                                </div>
                                <div class="actions">
                                    <div class="btn-group">
                                        ...
                                        <div id="sample_2_column_toggler"
                                            ...
                                            <label><input type="checkbox" checked data-column="0">complaint</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
			...
			<th>Complaiint</th>
					...
					<td>{!! $complaint->complaiint !!}</td>
                                            <td>
                                                <a class='btn btn-info fa fa-eye'
                                                href="/myadmin/complaints/{!!$complaint->id!!}"></a>
                                                <a class='btn btn-info fa fa-edit'
                                                       href="/myadmin/complaints/{!!$complaint->id!!}/edit"> </a>

                                                    <a href="{!! route('complaints.delete', [$complaint->id]) !!}"
                                                       onclick="return confirm('Are you sure wants to delete this complaint?')"><i
